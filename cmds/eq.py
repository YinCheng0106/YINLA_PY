...
class EQ(Cog_EX):
    ...
    async def eq(self, ctx):
            ...
            embed=discord.Embed(title="<a:ezgif:1000944717653090365> | 地震報告",description = message, color=0xff0000, timestamp = datetime.datetime.now())
            embed.add_field(name = "編號", value = "`第 " + number + " 號`")
